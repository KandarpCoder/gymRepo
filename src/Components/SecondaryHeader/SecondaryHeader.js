...
const SecondaryHeader = () => {
    ...
    useEffect(() => {
        if (location.pathname === "/services") {
            ...
            setHeaderText("Phn No:9931161153");
    ...
    return (
        <main className="secondaryHeader">
            <nav className="navBar">
                <h2>
                    RGOLDS <span style={{ color: "goldenrod" }}>GYM</span>{" "}
                </h2>
                <section className="navOption">
                    ...
                    <p>
                        <Link
                            to="/services"
                            style={{
                                color: location.pathname === "/services" && "goldenrod",
                            }}
                        >
                            Products
            </Link>
                    ...
                    <p>
                        <Link
                            to="/ourClasses"
                            style={{
                                color: location.pathname === "/ourClasses" && "goldenrod",
                            }}
                        >
                            Our Classes
            </Link>
                    ...
                    <p>
                        <Link
                            to="/aboutUs"
                            style={{ color: location.pathname === "/aboutUs" && "goldenrod" }}
                        >
                            About us
            </Link>
                    </p>
                    <p>
                        {/* <Link
                            to="/blog"
                            style={{ color: location.pathname === "/blog" && "goldenrod" }}
                        >
                            Blog
            </Link> */}
                    </p>
                    <p>
                        <Link
                            to="/pricing"
                            style={{ color: location.pathname === "/pricing" && "goldenrod" }}
                        >
                            Pricing
            </Link>
                    </p>
                    <p>
                        <Link
                            to="/contactUs"
                            style={{
                                color: location.pathname === "/contactUs" && "goldenrod",
                            }}
                        >
                            Contact us
            </Link>
                    ...
                    >
                        ...
                        >
                            <MenuItem
                                style={{
                                    backgroundColor:
                                        location.pathname === "/services" && "goldenrod",
                                    fontWeight: "600",
                                }}
                                onClick={handleClose}
                            >
                        ...
                        >
                            <MenuItem
                                style={{
                                    backgroundColor:
                                        location.pathname === "/ourClasses" && "goldenrod",
                                    fontWeight: "600",
                                }}
                                onClick={handleClose}
                            >
                        ...
                        >
                            <MenuItem
                                style={{
                                    backgroundColor:
                                        location.pathname === "/aboutUs" && "goldenrod",
                                    fontWeight: "600",
                                }}
                                onClick={handleClose}
                            >
                        ...
                        >
                            <MenuItem
                                style={{
                                    backgroundColor:
                                        location.pathname === "/pricing" && "goldenrod",
                                    fontWeight: "600",
                                }}
                                onClick={handleClose}
                            >
                        ...
                        >
                            <MenuItem
                                style={{
                                    backgroundColor:
                                        location.pathname === "/contactUs" && "goldenrod",
                                    fontWeight: "600",
                                }}
                                onClick={handleClose}
                            >
